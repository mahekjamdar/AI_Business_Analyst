...
# ============================================================
    ...
    st.write(
        "Ask a business question about sales, profit, "
        "regions, categories, products, orders, or trends."
    )
    ...
    if question:
        ...
        # ----------------------------------------------------
            ...
            if len(found) >= 2:
                ...
                first = result_map.get(
                    found[0]
                )

                second = result_map.get(
                    found[1]
                )
